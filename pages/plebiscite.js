...
const Page = () => {
    ...
    return (
        <div className={classes.rootContainer}>
            ...
            <div
                style={{
                    backgroundImage: `url(${cdnURL}/hill-blue.png)`,
                    backgroundSize: "fit",
            ...
            >
                ...
                >
                    <Grid item md={5} xs={12}>
                        <img
                            src={`${cdnURL}/consti-logo-colored.png`}
                            width="100%"
                        ...
                        <Button
                            onClick={() => {
                                window.open(
                                    `${cdnURL}/2020%20SAMAHAN%20Constitution.pdf`,
                                    "_blank"
                                );
                            }}
                            color="primary"
                            variant="contained"
                        >
                            SAMAHAN 2020 Constitution Final Draft
                        </Button>
                        <br />
                        <br />
                        <Button
                            onClick={() => {
                                window.open(
                                    `${cdnURL}/What%E2%80%99s%20new%20in%20the%202020%20SAMAHAN%20Constitution_.pdf`,
                                    "_blank"
                                );
                            }}
                            color="primary"
                            variant="contained"
                        >
                            What's new in the SAMAHAN Constitution?
                        </Button>
                    </Grid>
            ...
            <div
                style={{
                    backgroundImage:
                        "linear-gradient(180deg, #3b37ff, transparent, transparent, transparent, transparent, transparent)",
                }}
            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <FormControlLabel
                                                            ...
                                                            label="I approve the newly proposed 2020 SAMAHAN Constitution"
                                                        />
                                                        <FormControlLabel
                                                            value="no"
                                                            control={
                                                            ...
                                                            label="I don't approve the newly proposed 2020 SAMAHAN Constitution"
                                                        />
                                                    </RadioGroup>
                                                </FormControl>
            ...
            >
                <Grid item md={6} xs={12}>
                    ...
                    >
                        <p>
                            This academic year, the SAMAHAN Central Board with
                            the leadership of the SAMAHAN Department of Students
                            Rights and Welfare reinforces its solidified effort
                            to finally translate a dream into a reality.{" "}
                        </p>
                        <p>
                            After years reform attempts, it is about time that
                            the student body shall come together to pave the way
                            to the genesis of a new SAMAHAN Constitution. A
                            constitution that is responsive to the current
                            setting of Ateneo, a constitution that could
                            withstand the changing of times, and a constitution
                            that puts premium significance to wider student
                            representation and autonomy.{" "}
                        </p>
                        <p>
                            Let us all unite and take part of this change. This
                            is our{" "}
                            <b>
                                constitution – CONSTI NATIN TO! Bagong Consti,
                                Bagong SAMAHAN.
                            </b>
                        </p>
                    </Typography>
                ...
                <Grid item md={6} xs={12}>
                    <Grid container justify="center">
                        <Grid item>
                            <iframe
                                className={classes.avp}
                                src="https://www.youtube.com/embed/Fq8qcSEBeV8?controls=1&loop=1&autoplay=1"
                                frameBorder="0"
            ...
            <div style={{ backgroundColor: "#6195D1", padding: 0 }}>
                <div
                    style={{
                        backgroundImage: `url(${cdnURL}/consti-logo.png)`,
                    ...
                    <Grid container>
                        <Grid item xs={12} md={6} style={{ padding: 20 }}>
                            <Grid
                                ...
                                alignItems="center"
                                style={{
                                    backgroundImage: `url(${cdnURL}/consti-person.png)`,
                        ...
                        <Grid item xs={12} md={6} style={{ padding: 20 }}>
                            <Grid
                                ...
                                justify="center"
                                style={{
                                    backgroundImage: `url(${cdnURL}/functions-person.png)`,
                                    backgroundSize: "contain",
                        ...
                        >
                            <Grid
                                ...
                                justify="center"
                                style={{
                                    backgroundImage: `url(${cdnURL}/revise-person.png)`,
                                    backgroundSize: "contain",
                                    backgroundPosition: "left bottom",
                                    backgroundRepeat: "no-repeat",
                                    minHeight: 300,
                        ...
                        >
                            <Grid
                                ...
                                justify="center"
                                style={{
                                    backgroundImage: `url(${cdnURL}/ratify-person.png)`,
                                    backgroundSize: "contain",
                                    backgroundPosition: "right bottom",
                                    backgroundRepeat: "no-repeat",
                                    minHeight: 300,
            ...
            >
                <DialogContent>
                    {slide === "results" ? <ResultsTable /> : slide}
                </DialogContent>
                <DialogActions>
