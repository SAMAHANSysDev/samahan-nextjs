    ...
    <div className={classes.rootContainer}>
      ...
      <div style={{ margin: 'auto', width: '90%' }}>
        <Grid container direction="row" spacing={6} className={classes.contentContainer}>
          <Grid item sm={8}>
            <Typography variant="h4" component="h2">Why do we need to revise and ratify the SAMAHAN Constitution?</Typography>
            <Typography variant="h6" component="h2">Revise?</Typography>
            ...
            <Typography variant="h6" component="h2">Ratify?</Typography>
            ...
            <div style={{ height: 50 }}></div>
            <Typography variant="h4" component="h2">Plan of Actions</Typography>
