...
const Page = () => {
  ...
  return (
    <div className={classes.rootContainer}>
      ...
      <Head>
        <title>iHELP - SAMAHAN</title>
        <meta name="description" content="Student-initiated efforts to address and respond to emergencies" />
        <meta name="twitter:card" value="summary" />
        <meta property="og:title" content="iHELP" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://samahan.snry.xyz/projects/ihelp" />
        <meta property="og:description" content="Student-initiated efforts to address and respond to emergencies" />
      </Head>
      ...
      <div style={{ margin: 'auto', width: '90%' }}>
        <Grid container direction="row" spacing={6} className={classes.contentContainer}>
          <Grid item sm={8}>
            ...
            <p>For the past academic year, we, as a university community, have endured more calamities than is deemed necessary. From natural calamities to pandemics, we recognize that, even in the most difficult times, we continue to extend our help and support for each other. However, this does not erase the difficulties that come with each calamity we have to face. There have been issues on the timeliness of aid provided, monitoring of students in need, on answering concerns, etc. </p>
            <p>iHelp is a flagship program of the SAMAHAN, under the Department of Campaigns and Advocacies, for the academic year 2020-21 that is targeted to addressing these issues. Through maximizing our digital platforms, it <b>aims to establish a defined system in order to check and monitor Ateneans during calamities</b>. Thus, by creating a more efficient checking system, we will be able to <b>streamline the efforts of the university</b>, along with its partners, in order to provide help when and where it is most crucial. </p>
            <p>To achieve this, we will <b>create an online database for all students enrolled in Ateneo de Davao University</b>. This will allow us to track students who are most at risk or most affected by calamities. In turn, this would aid to consolidate the information needed by the university in order assist these students. Consequently, <b>all SAMAHAN-initiate donation drives will be under iHelp</b> in order to lessen logistical confusion. </p>
            <p>Through the use of social media, we will <b>establish an online response system</b> aimed at answering questions or calls for assistance. <b>A help desk will be established through Twitter and Facebook</b> in order to cater to constituent concerns. Information and publicity materials will also be disseminated online. Students will be made aware of the color-coding system when addressing a specific calamity. </p>
            <p>In total, <b>iHelpSAMAHAN will be the umbrella program for all SAMAHAN- initiated efforts at addressing and aiding calamities</b>. Internally, this will establish a clear set of protocols in order to effectively heed the calls of the students during times of crisis. This will streamline the efforts made in partnership with university offices like UCEAC, or with other clubs within the Ateneo. Externally, it will endeavor to create linkages or establish contact with other organizations that may help in providing assistance. </p>
