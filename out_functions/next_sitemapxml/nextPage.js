...
/******/ 	return __webpack_require__(__webpack_require__.s = "bqTH");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("gi6f")
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/sitemap.xml", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getServerSideProps", function() { return getServerSideProps; });
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("IhgX");
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(utils_wordpress__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var navigation_routes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("OOmI");
/* harmony import */ var navigation_routes__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(navigation_routes__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("wyBh");
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(utils_constants__WEBPACK_IMPORTED_MODULE_2__);
/**
 * 
...
const createSitemap = posts => `<?xml version="1.0" encoding="UTF-8"?>
  ...
  ${navigation_routes__WEBPACK_IMPORTED_MODULE_1___default.a.map(page => {
  if ('submenu' in page) {
    return page.submenu.map(sub => {
      return `
            <url>
              <loc>${`${utils_constants__WEBPACK_IMPORTED_MODULE_2__["frontendURL"]}${sub.href}`}</loc>
            </url>
          `;
    }).join('');
  }
  ...
  return `
        <url>
          <loc>${`${utils_constants__WEBPACK_IMPORTED_MODULE_2__["frontendURL"]}${page.href}`}</loc>
        </url>
      `;
}).join('')}
  ${posts.map(({
  ...
  return `
        <url>
          <loc>${`${utils_constants__WEBPACK_IMPORTED_MODULE_2__["frontendURL"]}/newsfeed/${slug}`}</loc>
        </url>
      `;
}).join('')}
  </urlset>
...
async function getServerSideProps({
  ...
  try {
    posts = await utils_wordpress__WEBPACK_IMPORTED_MODULE_0___default.a.posts();
  } catch (err) {
    posts = [];
  }
