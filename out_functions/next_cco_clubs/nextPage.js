...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"2":"06d7c83e9902cd7ee2dc","23":"156aab04dd50081db9a9","30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "zFTJ");
/******/ })
/************************************************************************/
/******/ ({
...
const ClubsList = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 23).then(__webpack_require__.bind(null, "TLy7")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("TLy7")],
    modules: ['components/cco/clubs']
  }
});
...
async function getStaticProps(ctx) {
  try {
    let clubs = await utils_wordpress__WEBPACK_IMPORTED_MODULE_3___default.a.ccoClubs().perPage(100);
    fast_sort__WEBPACK_IMPORTED_MODULE_4___default()(clubs).asc(x => x.acf.short_name);
    return {
      props: {
        clubs
      },
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("xkmO")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/cco/clubs'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/cco/clubs", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
