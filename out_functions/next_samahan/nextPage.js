...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"25":"3bf72ac1fad199d0f7ee","26":"e8803d2f1839a7cbe147","27":"f05d6208976def061893","30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe","43":"40684760f2b10efe7467"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "54dz");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("Ax0J")
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/samahan", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
/* harmony import */ var _material_ui_core_Hidden__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("Y8uC");
...
const Advocasix = next_dynamic__WEBPACK_IMPORTED_MODULE_7___default()(() => __webpack_require__.e(/* import() */ 43).then(__webpack_require__.bind(null, "mVOI")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("mVOI")],
    modules: ['components/samahan/advocasix']
  }
});
const BoardMembers = next_dynamic__WEBPACK_IMPORTED_MODULE_7___default()(() => __webpack_require__.e(/* import() */ 25).then(__webpack_require__.bind(null, "HHYH")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("HHYH")],
    modules: ['components/samahan/board-members']
  }
});
const ClusterReps = next_dynamic__WEBPACK_IMPORTED_MODULE_7___default()(() => __webpack_require__.e(/* import() */ 26).then(__webpack_require__.bind(null, "FxU+")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("FxU+")],
    modules: ['components/samahan/cluster-reps']
  }
});
const Departments = next_dynamic__WEBPACK_IMPORTED_MODULE_7___default()(() => __webpack_require__.e(/* import() */ 27).then(__webpack_require__.bind(null, "3+da")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("3+da")],
    modules: ['components/samahan/departments']
  }
});
...
const Page = ({
  ...
  return __jsx("div", {
    ...
    item: true,
    sm: 9,
    component: _material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_4___default.a,
    elevation: 0
  ...
  }, "SAMAHAN"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default.a, {
    variant: "body1",
    style: {
      marginBottom: 10
    }
  }, "The Samahan ng mga Mag-aaral ng Pamantasan ng Ateneo de Davao, or SAMAHAN, is the official Student Government of the Higher Education Unit of the Ateneo de Davao University. It is an autonomous student government that is mandated to promote and protect the rights, welfare, aspirations, and interests of the student body."), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default.a, {
    variant: "body1",
    style: {
      marginBottom: 10
    }
  }, "SAMAHAN promotes various advocacies that pertain to social justice, climate action, equal rights, and many more that promote the welfare of individuals inside and outside of the university. The SAMAHAN aims to fulfill not only our duties, but to also move forward with the student community in transforming into leaders of today for the university, Mindanao, and Philippines.")), __jsx(_material_ui_core_Hidden__WEBPACK_IMPORTED_MODULE_5___default.a, {
    smDown: true
  }, __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default.a, {
    item: true,
    sm: true
  }, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_9__["cdnURL"]}/samahanDesc.png`,
    width: "100%"
  })))), __jsx("div", {
    style: {
      height: 100
    ...
    item: true,
    sm: true,
    className: classes.motionLogoContainer
  }, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_9__["cdnURL"]}/samahanMotion.svg`,
  ...
  }, "More in Motion"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default.a, {
    variant: "body1",
    style: {
      marginBottom: 10
    }
  }, "The central point of being in motion is that the SAMAHAN is dynamic, flexible, and mobile. All these point out that it is in constant progress. The motion does not only revolve around working to fulfill the duties, but it also refers to the joint move- ment of the SAMAHAN, as one student government, to be active pursuers of \u201Cmore.\u201D The SAMAHAN highlights its collective action as it links its ideals to those of the promising sections of Ateneo \u2013 the artists, athletes, scholars, business enthusiasts, digitally inclined students \u2013 to build strong relations that yield meaningful outcomes. It gears towards a community of workers, performers, and leaders mobilized through partnerships and empowerment of students who are driven to create impact and inspire more people to do the same."))), __jsx("div", {
    style: {
      height: 100
    }
  }), __jsx("div", {
  ...
  }), __jsx(Advocasix, null), __jsx("div", {
    style: {
      height: 100
    }
  }), __jsx(BoardMembers, {
    members: centralBoard
  }), __jsx("div", {
    style: {
      height: 100
    }
...
async function getStaticProps(ctx) {
  try {
    let [centralBoard, clusterReps, departments] = await Promise.all([utils_wordpress__WEBPACK_IMPORTED_MODULE_6___default.a.centralBoard().perPage(100), utils_wordpress__WEBPACK_IMPORTED_MODULE_6___default.a.clusterReps().perPage(100), utils_wordpress__WEBPACK_IMPORTED_MODULE_6___default.a.departments().perPage(100)]);
    fast_sort__WEBPACK_IMPORTED_MODULE_8___default()(centralBoard).asc(x => parseInt(x.acf.order));
    fast_sort__WEBPACK_IMPORTED_MODULE_8___default()(clusterReps).asc(x => x.acf.position);
    fast_sort__WEBPACK_IMPORTED_MODULE_8___default()(departments).asc(x => x.acf.name);
    return {
      props: {
        centralBoard,
        clusterReps,
