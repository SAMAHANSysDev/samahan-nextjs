...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "GZeS");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("Li0t")
    ...
    const dynamicRouteMatcher = getRouteMatcher(getRouteRegex("/newsfeed/[slug]"))
  
    
      const defaultRouteRegex = getRouteRegex("/newsfeed/[slug]")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/newsfeed/[slug]'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        const nowParams = req.headers && req.headers["x-now-route-matches"]
              ? getRouteMatcher(
                  (function() {
                    const { re, groups } = getRouteRegex("/newsfeed/[slug]");
                    return {
                      re: {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/newsfeed/[slug]", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("IhgX");
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(utils_wordpress__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _material_ui_core_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("9Pu4");
/* harmony import */ var _material_ui_core_styles__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _material_ui_core_List__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("0LMq");
...
/* harmony import */ var _material_ui_core_ListItem__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("c25J");
...
/* harmony import */ var _material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("1imS");
...
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("wyBh");
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(utils_constants__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var react_gutenberg__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("Uewj");
...
const page = props => {
  ...
  if (!post) {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx("meta", {
      name: "robots",
      content: "noindex"
    })), __jsx(next_error__WEBPACK_IMPORTED_MODULE_6___default.a, {
      statusCode: 404
    }));
  }
  ...
  return __jsx("div", {
    className: classes.contentContainer
  }, __jsx(next_head__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx("title", null, post.title.rendered, " - SAMAHAN Newsfeed"), __jsx("meta", {
    name: "description",
    ...
    property: "og:type",
    content: "article"
  }), post.jetpack_featured_media_url ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("meta", {
    property: "og:image",
    ...
    property: "og:image",
    content: `${utils_constants__WEBPACK_IMPORTED_MODULE_13__["cdnURL"]}/samahan-seo-default.png`
  }), __jsx("meta", {
    name: "twitter:image",
    content: `${utils_constants__WEBPACK_IMPORTED_MODULE_13__["cdnURL"]}/samahan-seo-twitter-default.png`
  })), __jsx("meta", {
    property: "og:url",
    content: `${utils_constants__WEBPACK_IMPORTED_MODULE_13__["frontendURL"]}/newsfeed/${post.slug}`
  }), __jsx("meta", {
    property: "og:description",
    content: post.excerpt.rendered.replace(/<[^>]+>/g, "")
  })), __jsx("div", {
  ...
  }, post.title.rendered), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_4___default.a, {
    variant: "subtitle2"
  }, "by ", author.name, " on ", new Date(post.date).toDateString()), post.jetpack_featured_media_url ? __jsx("img", {
    ...
    variant: "body1",
    component: "div"
  }, __jsx(react_gutenberg__WEBPACK_IMPORTED_MODULE_14___default.a, {
    blocks: post.blocks
  }))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_7___default.a, {
    item: true,
    sm: 4,
    ...
    variant: "h6",
    component: "h4"
  }, "Recent News"), __jsx(_material_ui_core_List__WEBPACK_IMPORTED_MODULE_9___default.a, {
    style: {
      width: "100%"
    }
  }, recentNews.map(recent => __jsx(_material_ui_core_ListItem__WEBPACK_IMPORTED_MODULE_10___default.a, {
    key: recent.id,
    button: true,
    onClick: () => {
    ...
    primary: recent.title.rendered,
    secondary: new Date(recent.date).toDateString()
  }))))))), __jsx("div", {
    className: classes.spacer
  }));
};
...
const getStaticPaths = async () => {
  ...
  try {
    res = await utils_wordpress__WEBPACK_IMPORTED_MODULE_1___default.a.posts();
  } catch (err) {
    res = [];
  }
...
const getStaticProps = async ctx => {
  ...
  try {
    res = await utils_wordpress__WEBPACK_IMPORTED_MODULE_1___default.a.posts().slug(ctx.params.slug);
  } catch (err) {
    res = [];
  }

  if (res.length > 0) {
    const [author, recent] = await Promise.all([utils_wordpress__WEBPACK_IMPORTED_MODULE_1___default.a.users().id(res[0].author), utils_wordpress__WEBPACK_IMPORTED_MODULE_1___default.a.posts().exclude(res[0].id).perPage(5).page(1)]);
    return {
      props: {
        post: res[0],
        author,
...
module.exports = require("react-gutenberg");
