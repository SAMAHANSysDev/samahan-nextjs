...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe","37":"d5d04449710d706a4498"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "9GqZ");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("sBzo")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/projects/student-services-manual'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/projects/student-services-manual", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
/* harmony import */ var fast_sort__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("83SR");
...
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("IhgX");
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(utils_wordpress__WEBPACK_IMPORTED_MODULE_7__);
...
const ServicesList = next_dynamic__WEBPACK_IMPORTED_MODULE_4___default()(() => __webpack_require__.e(/* import() */ 37).then(__webpack_require__.bind(null, "zNEu")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("zNEu")],
    modules: ['components/projects/student-services-manual/services-list']
  }
});
...
const Page = ({
  ...
  return __jsx("div", {
  ...
  }, "Student Services"), __jsx("br", null), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default.a, {
    variant: "subtitle1",
    component: "h2",
    style: {
      lineHeight: '1.5em'
    }
  }, "Student Manual for Services offered by the University"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default.a, {
    variant: "subtitle1",
    component: "h2",
    style: {
      lineHeight: '1.5em'
    ...
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_8__["cdnURL"]}/board-student-services.png`,
    style: {
      width: '100%',
      height: 'auto'
    }
...
async function getStaticProps(ctx) {
  try {
    let studentServices = await utils_wordpress__WEBPACK_IMPORTED_MODULE_7___default.a.studentServices().perPage(100);
    fast_sort__WEBPACK_IMPORTED_MODULE_5___default()(studentServices).asc(x => x.acf.name);
    return {
      props: {
        studentServices
      },
