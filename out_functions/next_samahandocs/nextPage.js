...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"0":"b0e442add12baccb5aca","1":"1b4dcb41d55cbf492ed9","30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe","40":"acbbb88310f72f187413"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "Lxs1");
/******/ })
/************************************************************************/
/******/ ({
...
const Banner = next_dynamic__WEBPACK_IMPORTED_MODULE_8___default()(() => __webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, "+GDU")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("+GDU")],
    modules: ['components/samahan-docs/banner']
  }
});
const NavButtons = next_dynamic__WEBPACK_IMPORTED_MODULE_8___default()(() => __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, "vDQ2")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("vDQ2")],
    modules: ['components/samahan-docs/nav-buttons']
  }
});
const Instructions = next_dynamic__WEBPACK_IMPORTED_MODULE_8___default()(() => __webpack_require__.e(/* import() */ 40).then(__webpack_require__.bind(null, "5Dy0")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("5Dy0")],
    modules: ['components/samahan-docs/reservations-ins']
  }
});
...
async function getStaticProps(ctx) {
  try {
    let docs = await utils_wordpress__WEBPACK_IMPORTED_MODULE_7___default.a.reservationDocs().perPage(100);
    fast_sort__WEBPACK_IMPORTED_MODULE_9___default()(docs).asc(x => x.acf.title);
    return {
      props: {
        docs
      },
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("4Gbo")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/samahan-docs'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/samahan-docs", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
