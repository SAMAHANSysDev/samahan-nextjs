...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"29":"874cc788a22c2ac05449","30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "jU3M");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var utils_google__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("3icA");
/* harmony import */ var utils_google__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(utils_google__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _material_ui_lab_Timeline__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("dMBU");
/* harmony import */ var _material_ui_lab_Timeline__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_Timeline__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _material_ui_lab_TimelineItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("00oV");
/* harmony import */ var _material_ui_lab_TimelineItem__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_TimelineItem__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _material_ui_lab_TimelineSeparator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("hCxv");
/* harmony import */ var _material_ui_lab_TimelineSeparator__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_TimelineSeparator__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _material_ui_lab_TimelineConnector__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("7amr");
/* harmony import */ var _material_ui_lab_TimelineConnector__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_TimelineConnector__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _material_ui_lab_TimelineContent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("bDw5");
/* harmony import */ var _material_ui_lab_TimelineContent__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_TimelineContent__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _material_ui_lab_TimelineOppositeContent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("EW0D");
/* harmony import */ var _material_ui_lab_TimelineOppositeContent__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_TimelineOppositeContent__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _material_ui_lab_TimelineDot__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("6ECf");
/* harmony import */ var _material_ui_lab_TimelineDot__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_material_ui_lab_TimelineDot__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("9BML");
...
const Banner = next_dynamic__WEBPACK_IMPORTED_MODULE_12___default()(() => __webpack_require__.e(/* import() */ 29).then(__webpack_require__.bind(null, "yz2V")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("yz2V")],
    modules: ['components/calendar/banner']
  }
});
...
const Page = ({
  ...
  const [events, setEvents] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState([]);
  const [nowString, setNowString] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState('');
  const [currentTime, setCurrentTime] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState(new Date());
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useEffect(() => {
    setEvents(rawEvents);
  }, []);
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useEffect(() => {
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useEffect(() => {
    if (events.length > 0) {
      if (Object(date_fns__WEBPACK_IMPORTED_MODULE_13__["differenceInSeconds"])(new Date(events[0].start.dateTime), new Date()) > 0) {
        setNowString(`You are ${Object(date_fns__WEBPACK_IMPORTED_MODULE_13__["formatDistanceToNow"])(new Date(events[0].start.dateTime))} away from the next event!`);
      } else {
  ...
  return __jsx("div", {
    ...
    className: classes.rootCalContainer
  }, __jsx("div", {
    className: classes.calendarContainer
  }, __jsx(_material_ui_lab_Timeline__WEBPACK_IMPORTED_MODULE_3___default.a, {
    align: "alternate"
  }, __jsx(_material_ui_lab_TimelineItem__WEBPACK_IMPORTED_MODULE_4___default.a, null, __jsx(_material_ui_lab_TimelineOppositeContent__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, {
    variant: "body2",
    color: "secondary"
  }, "This is you, right now."), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, {
    variant: "body2",
    color: "secondary"
  }, Object(date_fns__WEBPACK_IMPORTED_MODULE_13__["format"])(currentTime, 'MMM d, yyyy (h:mm a)'))), __jsx(_material_ui_lab_TimelineSeparator__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx(_material_ui_lab_TimelineDot__WEBPACK_IMPORTED_MODULE_9___default.a, null), __jsx(_material_ui_lab_TimelineConnector__WEBPACK_IMPORTED_MODULE_6___default.a, null)), __jsx(_material_ui_lab_TimelineContent__WEBPACK_IMPORTED_MODULE_7___default.a, null, __jsx(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_10___default.a, {
    elevation: 0,
    className: classes.paper
  }, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, null, nowString)))), events.length > 0 ? events.map(event => __jsx(_material_ui_lab_TimelineItem__WEBPACK_IMPORTED_MODULE_4___default.a, {
    key: event.id
  }, __jsx(_material_ui_lab_TimelineOppositeContent__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, {
    variant: "body2",
    color: "secondary"
  }, "Start: ", Object(date_fns__WEBPACK_IMPORTED_MODULE_13__["format"])(new Date(event.start.dateTime), 'MMM d, yyyy (h:mm a)')), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, {
    variant: "body2",
    color: "secondary"
  }, "End: ", Object(date_fns__WEBPACK_IMPORTED_MODULE_13__["format"])(new Date(event.end.dateTime), 'MMM d, yyyy (h:mm a)')), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, {
    variant: "body2",
    color: "secondary"
  }, event.location)), __jsx(_material_ui_lab_TimelineSeparator__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx(_material_ui_lab_TimelineDot__WEBPACK_IMPORTED_MODULE_9___default.a, null), __jsx(_material_ui_lab_TimelineConnector__WEBPACK_IMPORTED_MODULE_6___default.a, null)), __jsx(_material_ui_lab_TimelineContent__WEBPACK_IMPORTED_MODULE_7___default.a, null, __jsx(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_10___default.a, {
    elevation: 0,
    className: classes.paper
  }, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, {
    variant: "h6",
    component: "h1"
  }, event.summary), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11___default.a, null, event.description))))) : null))));
};

async function getStaticProps(ctx) {
  try {
    const events = (await utils_google__WEBPACK_IMPORTED_MODULE_2___default.a.events.list({
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("B+Aq")
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/calendar", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
