...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"2":"06d7c83e9902cd7ee2dc","24":"22d90e814e89285d8952","30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "Qjjf");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("qQ/p")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/cco/officers'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/cco/officers", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("IhgX");
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(utils_wordpress__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var fast_sort__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("83SR");
/* harmony import */ var fast_sort__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(fast_sort__WEBPACK_IMPORTED_MODULE_4__);
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const OfficersList = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 24).then(__webpack_require__.bind(null, "wc7s")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("wc7s")],
    modules: ['components/cco/officers']
  }
});
const CCOBanner = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, "SkXI")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("SkXI")],
    modules: ['components/cco/banner']
  }
});
...
const Page = ({
  ...
  }), __jsx(CCOBanner, null), __jsx("div", {
    style: {
      height: 100
    }
  }), __jsx("div", {
...
async function getStaticProps(ctx) {
  try {
    let officers = await utils_wordpress__WEBPACK_IMPORTED_MODULE_3___default.a.ccoOfficers().perPage(100);
    fast_sort__WEBPACK_IMPORTED_MODULE_4___default()(officers).asc(x => parseInt(x.acf.order));
    return {
      props: {
        officers
      },
