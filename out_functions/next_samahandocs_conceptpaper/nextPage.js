...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"0":"b0e442add12baccb5aca","1":"1b4dcb41d55cbf492ed9","30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe","38":"e9e17b9b7255c59fdd9d"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "Daw9");
/******/ })
/************************************************************************/
/******/ ({
...
const Instructions = next_dynamic__WEBPACK_IMPORTED_MODULE_7___default()(() => __webpack_require__.e(/* import() */ 38).then(__webpack_require__.bind(null, "hkK6")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("hkK6")],
    modules: ['components/samahan-docs/concept-paper-ins']
  }
});
...
async function getStaticProps(ctx) {
  try {
    let docs = await utils_wordpress__WEBPACK_IMPORTED_MODULE_6___default.a.conceptDocs().perPage(100);
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("Cztd")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/samahan-docs/concept-paper'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/samahan-docs/concept-paper", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
