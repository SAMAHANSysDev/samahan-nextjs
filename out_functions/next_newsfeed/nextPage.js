...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe","34":"4f3842581ad82848a410"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "RthS");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("wyBh");
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(utils_constants__WEBPACK_IMPORTED_MODULE_7__);
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const Item = next_dynamic__WEBPACK_IMPORTED_MODULE_5___default()(() => __webpack_require__.e(/* import() */ 34).then(__webpack_require__.bind(null, "r7gU")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("r7gU")],
    modules: ["components/home/newsfeed-item"]
  }
});
...
const Page = ({
  ...
  }, "SAMAHAN NEWSFEED"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default.a, {
    variant: "subtitle1",
    component: "h2",
    style: {
      lineHeight: "1.5em"
    }
  }, "News and Stories of and for the Student Body")), __jsx("div", {
    style: {
      height: 50
    }
  }), __jsx("div", {
  ...
  }, "Check our"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default.a, {
    variant: "h2",
    style: {
      lineHeight: "0.8em"
    }
  }, "latest release"), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
    variant: "contained",
    color: "secondary",
    style: {
      marginTop: 20
  ...
  }, "Click here"))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default.a, {
    item: true,
    sm: 6,
    className: classes.pictureContainer
  }, __jsx("center", null, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_7__["cdnURL"]}/newsfeed.png`,
    style: {
      width: "50%"
    }
  }))))));
...
async function getStaticProps(ctx) {
  try {
    const [res, users] = await Promise.all([utils_wordpress__WEBPACK_IMPORTED_MODULE_4___default.a.posts().perPage(100), utils_wordpress__WEBPACK_IMPORTED_MODULE_4___default.a.users().perPage(100)]);
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("F6YL")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/newsfeed'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/newsfeed", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
