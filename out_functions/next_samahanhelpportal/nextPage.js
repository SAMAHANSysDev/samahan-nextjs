...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"30":"57872a1af47177cea15d","31":"815c2a369b6549b3fafe","41":"37e638d9749072d02333","42":"f4b0db41e5d128d1178b"}[chunkId] + ".js");
...
/******/ 	return __webpack_require__(__webpack_require__.s = "cnum");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = require("@material-ui/icons/AttachMoneyOutlined");
...
/* harmony import */ var next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_node_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2__);
    ...
    const ComponentInfo = __webpack_require__("rG6s")
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/samahan-help-portal'){
            break
          }
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        if (false) {}
        let result = await renderToHTML(req, res, "/samahan-help-portal", Object.assign({}, getStaticProps ? { ...(parsedUrl.query.amp ? { amp: '1' } : {}) } : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("IhgX");
/* harmony import */ var utils_wordpress__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(utils_wordpress__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var next_dynamic__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("/T1H");
/* harmony import */ var next_dynamic__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(next_dynamic__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var react_twitter_embed__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("5dk1");
...
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("wyBh");
/* harmony import */ var utils_constants__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(utils_constants__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var fast_sort__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("83SR");
/* harmony import */ var fast_sort__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(fast_sort__WEBPACK_IMPORTED_MODULE_9__);
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const FAQs = next_dynamic__WEBPACK_IMPORTED_MODULE_5___default()(() => __webpack_require__.e(/* import() */ 41).then(__webpack_require__.bind(null, "RKBs")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("RKBs")],
    modules: ['components/samahan-help-portal/faqs']
  }
});
const RedirectButtons = next_dynamic__WEBPACK_IMPORTED_MODULE_5___default()(() => __webpack_require__.e(/* import() */ 42).then(__webpack_require__.bind(null, "GP/v")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("GP/v")],
    modules: ['components/samahan-help-portal/redirect-buttons']
  }
});
...
const Page = ({
  ...
  return __jsx("div", {
  ...
  }, "SAMAHAN"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default.a, {
    variant: "h1",
    component: "h2",
    style: {
      lineHeight: '0.8em'
    }
  }, "HELP PORTAL"), __jsx("br", null), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default.a, {
    variant: "subtitle1",
    component: "h2",
    style: {
      lineHeight: '1.5em'
    }
  }, "Concerns, Questions & Queries"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default.a, {
    variant: "subtitle1",
    component: "h2",
    style: {
      lineHeight: '1.5em'
    }
  }, "samahan.addu.edu.ph")), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_3___default.a, {
    item: true,
    sm: true
  }, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_8__["cdnURL"]}/Concerns-Flowchart-White.png`,
    style: {
      width: '100%',
      height: 'auto'
    }
  ...
  }, __jsx(RedirectButtons, null), __jsx("div", {
    style: {
      height: 100
    }
  }), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_3___default.a, {
    ...
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_8__["cdnURL"]}/Enroll-in-3-Steps-1.png`
  })), __jsx("div", null, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_8__["cdnURL"]}/Enroll-in-3-Steps-2.png`
  })), __jsx("div", null, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_8__["cdnURL"]}/Enroll-in-3-Steps-3.png`
  })), __jsx("div", null, __jsx("img", {
    src: `${utils_constants__WEBPACK_IMPORTED_MODULE_8__["cdnURL"]}/Enroll-in-3-Steps-4.png`
  }))), __jsx("div", {
    style: {
      height: 20
    }
  }), __jsx(react_twitter_embed__WEBPACK_IMPORTED_MODULE_6__["TwitterTimelineEmbed"], {
    sourceType: "profile",
...
async function getStaticProps(ctx) {
  try {
    const res = await utils_wordpress__WEBPACK_IMPORTED_MODULE_4___default.a.helpPortal().perPage(30);
    fast_sort__WEBPACK_IMPORTED_MODULE_9___default()(res).asc(x => x.acf.question);
